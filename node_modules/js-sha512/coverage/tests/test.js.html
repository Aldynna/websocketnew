...
<html lang="en">
<head>
    <title>Code coverage report for tests/test.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">tests</a> test.js
    </h1>
    <div class='clearfix'>
...
332
333
334</td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">(function (sha512, sha384, sha512_256, sha512_224) {
  Array.prototype.toHexString = ArrayBuffer.prototype.toHexString = <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var array = <span class="cstat-no" title="statement not covered" >new Uint8Array(this);</span>
    var hex = <span class="cstat-no" title="statement not covered" >'';</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; array.length; ++i) {</span>
      var c = <span class="cstat-no" title="statement not covered" >array[i].toString('16');</span>
<span class="cstat-no" title="statement not covered" >      hex += c.length === 1 ? '0' + c : c;</span>
    }
...
&nbsp;
  var errorTestCases = [null, undefined, { length: 0 }, 0, 1, false, true, NaN, Infinity, <span class="fstat-no" title="function not covered" >fu</span>nction () {}];
&nbsp;
